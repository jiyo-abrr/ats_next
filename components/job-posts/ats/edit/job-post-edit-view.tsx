...
import { ExclusionsPanel } from "./exclusions/exclusions-panel";
import { TemplatesPanel } from "./assessments/templates-panel";

export function JobPostEditView({ id }: { id: string }) {
    ...
    <div className="space-y-5">
      <Breadcrumbs
        items={[
          ...
          { label: job.job_title, href: `/ats/job-posts/${job.id}` },
          { label: "Edit" },
        ]}
      />
      <Link
        href={`/ats/job-posts/${job.id}`}
